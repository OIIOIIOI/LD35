...
ApplicationMain.preload = function() {
	...
	ApplicationMain.loadFile("img/appear.png");
	ApplicationMain.loadFile("img/aura.png");
	ApplicationMain.loadBinary("img/aura.psd");
	ApplicationMain.loadBinary("img/bg.psd");
	ApplicationMain.loadFile("img/bgA.png");
	ApplicationMain.loadFile("img/bgB.png");
	ApplicationMain.loadFile("img/bgC.png");
	ApplicationMain.loadFile("img/bgD.png");
	ApplicationMain.loadFile("img/bgE.png");
	ApplicationMain.loadFile("img/bgF.png");
	ApplicationMain.loadFile("img/bonus.png");
	ApplicationMain.loadFile("img/enemy_0.png");
	ApplicationMain.loadFile("img/enemy_1.png");
	ApplicationMain.loadFile("img/enemy_2.png");
	ApplicationMain.loadFile("img/font.png");
	ApplicationMain.loadFile("img/gameover.png");
	ApplicationMain.loadFile("img/parts_0.png");
	ApplicationMain.loadFile("img/parts_1.png");
	ApplicationMain.loadFile("img/parts_2.png");
	ApplicationMain.loadFile("img/player.png");
	ApplicationMain.loadFile("img/split_0.png");
	ApplicationMain.loadFile("img/split_1.png");
	ApplicationMain.loadFile("img/title.png");
	ApplicationMain.loadBinary("img/title.psd");
	ApplicationMain.loadBinary("img/title2.psd");
	ApplicationMain.loadBinary("img/Untitled-1.psd");
	ApplicationMain.loadSound("snd/death.ogg");
	ApplicationMain.loadSound("snd/explode0.ogg");
	ApplicationMain.loadSound("snd/explode1.ogg");
	ApplicationMain.loadSound("snd/explode2.ogg");
	ApplicationMain.loadSound("snd/grindLOOP.ogg");
	ApplicationMain.loadSound("snd/pickup0.ogg");
	ApplicationMain.loadSound("snd/pickup1.ogg");
	ApplicationMain.loadSound("snd/pickup2.ogg");
...
var Bonus = function() {
	...
	this.setAnim(Sprites.BONUS);
	this.velMax = 8;
	this.collRadius = this.cx;
	this.collType = CollType.BONUS;
	this.collList.push(CollType.PLAYER);
};
$hxClasses["Bonus"] = Bonus;
Bonus.__name__ = ["Bonus"];
Bonus.__super__ = MovingEntity;
Bonus.prototype = $extend(MovingEntity.prototype,{
	update: function() {
		MovingEntity.prototype.update.call(this);
		var angle = Math.atan2(Game.INST.player.y + Game.INST.player.cy - this.y - this.cy,Game.INST.player.x + Game.INST.player.cx - this.x - this.cx);
...
var DefaultAssetLibrary = function() {
	...
	this.add("img/appear.png",openfl_AssetType.IMAGE);
	this.add("img/aura.png",openfl_AssetType.IMAGE);
	this.add("img/aura.psd",openfl_AssetType.BINARY);
	this.add("img/bg.psd",openfl_AssetType.BINARY);
	this.add("img/bgA.png",openfl_AssetType.IMAGE);
	this.add("img/bgB.png",openfl_AssetType.IMAGE);
	this.add("img/bgC.png",openfl_AssetType.IMAGE);
	this.add("img/bgD.png",openfl_AssetType.IMAGE);
	this.add("img/bgE.png",openfl_AssetType.IMAGE);
	this.add("img/bgF.png",openfl_AssetType.IMAGE);
	this.add("img/bonus.png",openfl_AssetType.IMAGE);
	...
	this.add("img/font.png",openfl_AssetType.IMAGE);
	this.add("img/gameover.png",openfl_AssetType.IMAGE);
	this.add("img/parts_0.png",openfl_AssetType.IMAGE);
	this.add("img/parts_1.png",openfl_AssetType.IMAGE);
	this.add("img/parts_2.png",openfl_AssetType.IMAGE);
	this.add("img/player.png",openfl_AssetType.IMAGE);
	this.add("img/split_0.png",openfl_AssetType.IMAGE);
	this.add("img/split_1.png",openfl_AssetType.IMAGE);
	this.add("img/title.png",openfl_AssetType.IMAGE);
	this.add("img/title.psd",openfl_AssetType.BINARY);
	this.add("img/title2.psd",openfl_AssetType.BINARY);
	this.add("img/Untitled-1.psd",openfl_AssetType.BINARY);
	this.add("snd/death.ogg",openfl_AssetType.SOUND);
	this.add("snd/explode0.ogg",openfl_AssetType.SOUND);
	this.add("snd/explode1.ogg",openfl_AssetType.SOUND);
	this.add("snd/explode2.ogg",openfl_AssetType.SOUND);
	this.add("snd/grindLOOP.ogg",openfl_AssetType.SOUND);
	this.add("snd/pickup0.ogg",openfl_AssetType.SOUND);
	this.add("snd/pickup1.ogg",openfl_AssetType.SOUND);
	this.add("snd/pickup2.ogg",openfl_AssetType.SOUND);
};
...
var Enemy = function(size,resetGrow) {
	if(resetGrow == null) resetGrow = false;
	if(size == null) size = 0;
...
Enemy.prototype = $extend(MovingEntity.prototype,{
	update: function() {
		MovingEntity.prototype.update.call(this);
		this.isInAura = false;
		if(this.x + this.cx > Game.WIDTH + Game.INST.shakeOffset || this.x + this.cx < Game.INST.shakeOffset) this.xVel = -this.xVel;
		if(this.y + this.cy > Game.HEIGHT + Game.INST.shakeOffset || this.y + this.cy < Game.INST.shakeOffset) this.yVel = -this.yVel;
	}
	,postUpdate: function() {
		...
		if(this.isInAura) {
			...
			this.shrink();
			this.rox = Std.random(2) * 2 - 1;
			this.roy = Std.random(2) * 2 - 1;
			var pType;
			var _g = this.currentSize;
			switch(_g) {
			case 0:
				pType = ParticleType.SIZE_A_PART;
				break;
			case 1:
				pType = ParticleType.SIZE_B_PART;
				break;
			case 2:
				pType = ParticleType.SIZE_C_PART;
				break;
			default:
				pType = ParticleType.DEFAULT;
			}
			Game.INST.spawnParticles(pType,this.x + this.cx,this.y + this.cy,1);
		} else {
			this.rox = this.roy = 0;
			this.grow();
		}
		...
		if(this.growTick <= this.growDelay) {
			...
			if(this.growTick >= this.growDelay) {
				...
				if(this.currentSize > 0) {
					var curAngleDeg = Math.atan2(this.yVel,this.xVel) * 180 / Math.PI;
					var e = new Enemy(this.currentSize - 1,true);
					e.x = this.x;
					e.y = this.y;
					...
					e = new Enemy(this.currentSize - 1,true);
					e.x = this.x;
					e.y = this.y;
					...
					switch(_g) {
					case 0:
						pType = ParticleType.SPLIT_A;
						break;
					default:
						pType = ParticleType.SPLIT_B;
					}
					...
					e1.x = this.x;
					e1.y = this.y;
					Game.INST.spawnEntity(e1);
					Game.INST.shake(5,12);
				}
			}
		}
	}
	,applySize: function(up) {
		if(up == null) up = true;
		this.setAnim(this.sizes[this.currentSize]);
		var diff = this.collRadius - this.cx;
		this.x += diff;
		this.y += diff;
		this.collRadius = this.cx;
		var mod = 1.2;
...
var CollType = $hxClasses["CollType"] = { __ename__ : true, __constructs__ : ["PLAYER","AURA","ENEMY","BONUS"] };
...
CollType.BONUS = ["BONUS",3];
CollType.BONUS.toString = $estr;
CollType.BONUS.__enum__ = CollType;
...
var Game = function() {
	...
	openfl_display_Sprite.call(this);
	this.canvasData = new openfl_display_BitmapData(Game.WIDTH + 2 * this.shakeOffset,Game.HEIGHT + 2 * this.shakeOffset,false);
	this.canvas = new openfl_display_Bitmap(this.canvasData);
	this.canvas.set_x(this.canvas.set_y(-this.shakeOffset));
	this.addChild(this.canvas);
	this.addChild(UI.INST.canvas);
	this.reset(true);
...
Game.prototype = $extend(openfl_display_Sprite.prototype,{
	reset: function(first) {
		...
		this.spawnTick = 10;
		this.shakeTick = 0;
		this.shakeMode = ShakeMode.FIXED;
		this.hasGameStarted = this.hasGameEnded = this.isGrinding = false;
		if(this.player == null) this.player = new Player();
		HxOverrides.remove(this.entities,this.player);
		this.entities.push(this.player);
		this.player.x = 322;
		this.player.y = 355;
		this.player.currentMove = Move.DEFAULT;
		this.setupBackground();
		UI.INST.reset(first);
		if(first) {
			this.title = new Title();
			this.title.x = this.title.y = this.shakeOffset;
	...
	,update: function(e) {
		...
		var wasGrinding = this.isGrinding;
		...
		this.particles = this.particles.filter($bind(this,this.filterDead));
		this.render();
		if(this.shakeTick > 0) {
			var sa = this.shakeAmount;
			if(this.shakeMode == ShakeMode.RANDOM) sa = Math.random() * this.shakeAmount;
			this.canvas.set_x(-this.shakeOffset + sa * Std.random(2) * 2 - 1);
			this.canvas.set_y(-this.shakeOffset + sa * Std.random(2) * 2 - 1);
			this.shakeTick--;
		} else if(this.shakeTick == 0) {
			this.canvas.set_x(this.canvas.set_y(-this.shakeOffset));
			this.shakeTick--;
		}
		if(this.isGrinding && !wasGrinding) SoundMan.playLoop(SoundMan.GRIND,0.5); else if(!this.isGrinding) SoundMan.stopLoop(SoundMan.GRIND);
	}
	,preSpawnEnemy: function() {
		var xx = this.player.x;
		var yy = this.player.y;
		while(this.getDistanceXY(xx,yy,this.player.x,this.player.y) <= (function($this) {
			var $r;
			var _this = Sprites.getSheet(Sprites.AURA).data;
			$r = _this.component.height;
			return $r;
		}(this)) / 2) {
			xx = Std.random(Game.WIDTH) + this.shakeOffset;
			yy = Std.random(Game.HEIGHT) + this.shakeOffset;
		}
		this.spawnParticles(ParticleType.APPEAR,xx,yy);
	}
	,spawnEnemy: function(xx,yy) {
		var e = new Enemy(0);
		e.x = xx;
		e.y = yy;
		this.spawnEntity(e);
	}
	,spawnEntity: function(e,playerOnTop) {
	...
	,spawnParticles: function(t,px,py,amount) {
	...
	,spawnFollowParticles: function(t,e,amount) {
		if(amount == null) amount = 1;
		var _g = 0;
		while(_g < amount) {
			var i = _g++;
		...
		while(_g1 < _g) {
			...
			while(_g3 < _g2) {
				...
				if(dist < ea.collRadius + eb.collRadius) {
					var continueLoop = this.resolveCollision(ea,eb,dist);
	...
	,resolveCollision: function(ea,eb,dist) {
		if(js_Boot.__instanceof(ea,Aura) && js_Boot.__instanceof(eb,Enemy)) this.enemyInAura(js_Boot.__cast(eb , Enemy)); else if(js_Boot.__instanceof(ea,Enemy) && js_Boot.__instanceof(eb,Aura)) this.enemyInAura(js_Boot.__cast(ea , Enemy)); else if(js_Boot.__instanceof(ea,Player) && js_Boot.__instanceof(eb,Bonus)) (js_Boot.__cast(eb , Bonus)).pickUp(); else if(js_Boot.__instanceof(ea,Bonus) && js_Boot.__instanceof(eb,Player)) (js_Boot.__cast(ea , Bonus)).pickUp(); else if(js_Boot.__instanceof(ea,Player) || js_Boot.__instanceof(eb,Player)) {
			this.endGame();
			return false;
		}
		return true;
	}
	,enemyInAura: function(e) {
		e.isInAura = true;
	...
	,getDistanceXY: function(eax,eay,ebx,eby) {
		var dx = ebx - eax;
		var dy = eby - eay;
		return Math.sqrt(dx * dx + dy * dy);
	}
	,render: function() {
		...
		while(_g < _g1.length) {
			var e = _g1[_g];
			++_g;
			Sprites.draw(this.canvasData,e.spriteID,e.x + e.rox,e.y + e.roy,e.frame);
		}
		var _g2 = 0;
		var _g11 = this.entities;
		while(_g2 < _g11.length) {
			var e1 = _g11[_g2];
			++_g2;
			Sprites.draw(this.canvasData,e1.spriteID,e1.x + e1.rox,e1.y + e1.roy,e1.frame);
		}
		var _g3 = 0;
		...
		while(_g3 < _g12.length) {
			var p = _g12[_g3];
			++_g3;
			Sprites.draw(this.canvasData,p.spriteID,p.x,p.y,p.frame);
		}
		UI.INST.render();
	}
	,shake: function(amount,duration,mode) {
		if(mode == null) mode = ShakeMode.FIXED;
		if(this.shakeTick == -1 || amount >= this.shakeAmount || mode == ShakeMode.FIXED) {
			this.shakeAmount = amount;
			this.shakeTick = duration;
			this.shakeMode = mode;
		}
	}
	,endGame: function() {
		...
		HxOverrides.remove(this.entities,this.aura);
		var e = new GameOver();
		e.x = Game.WIDTH / 2 - e.cx + this.shakeOffset;
		e.y = Game.HEIGHT / 2 - e.cy + this.shakeOffset;
		this.entities.push(e);
		var _g = 0;
		...
		while(_g < _g1.length) {
			var e1 = _g1[_g];
			++_g;
			if(js_Boot.__instanceof(e1,Bonus)) (js_Boot.__cast(e1 , Bonus)).pickUp();
		}
	}
	,__class__: Game
});
var ShakeMode = $hxClasses["ShakeMode"] = { __ename__ : true, __constructs__ : ["FIXED","RANDOM"] };
ShakeMode.FIXED = ["FIXED",0];
ShakeMode.FIXED.toString = $estr;
ShakeMode.FIXED.__enum__ = ShakeMode;
ShakeMode.RANDOM = ["RANDOM",1];
ShakeMode.RANDOM.toString = $estr;
ShakeMode.RANDOM.__enum__ = ShakeMode;
var GameOver = function() {
	Entity.call(this);
	this.setAnim(Sprites.GAME_OVER);
};
$hxClasses["GameOver"] = GameOver;
GameOver.__name__ = ["GameOver"];
GameOver.__super__ = Entity;
GameOver.prototype = $extend(Entity.prototype,{
	__class__: GameOver
});
...
var Particle = function(t) {
	...
	switch(t[1]) {
	case 1:
		this.lifetime = 30 + Std.random(30);
		this.setAnim(Sprites.SIZE_A_PART);
		this.xVel = (Std.random(2) * 2 - 1) * (Math.random() * 0.5);
		this.yVel = (Std.random(2) * 2 - 1) * (Math.random() * 0.5);
		break;
	case 2:
		this.lifetime = 30 + Std.random(30);
		this.setAnim(Sprites.SIZE_B_PART);
		this.xVel = (Std.random(2) * 2 - 1) * (Math.random() * 0.5);
		this.yVel = (Std.random(2) * 2 - 1) * (Math.random() * 0.5);
		break;
	case 3:
		this.lifetime = 30 + Std.random(30);
		this.setAnim(Sprites.SIZE_C_PART);
		this.xVel = (Std.random(2) * 2 - 1) * (Math.random() * 0.5);
		this.yVel = (Std.random(2) * 2 - 1) * (Math.random() * 0.5);
		break;
	case 4:
		var sheet = Sprites.getSheet(Sprites.SPLIT_A);
		this.lifetime = sheet.frames * sheet.delay;
		this.setAnim(Sprites.SPLIT_A);
		break;
	case 5:
		var sheet1 = Sprites.getSheet(Sprites.SPLIT_B);
		this.lifetime = sheet1.frames * sheet1.delay;
		this.setAnim(Sprites.SPLIT_B);
		break;
	case 6:
		var sheet2 = Sprites.getSheet(Sprites.APPEAR);
		this.lifetime = sheet2.frames * sheet2.delay;
		this.setAnim(Sprites.APPEAR);
		break;
	default:
		this.lifetime = 80 + Std.random(120);
		this.setAnim(Sprites.DEFAULT_PART);
		this.xVel = (Std.random(2) * 2 - 1) * (Math.random() * 0.5);
...
Particle.__super__ = MovingEntity;
Particle.prototype = $extend(MovingEntity.prototype,{
	update: function() {
		MovingEntity.prototype.update.call(this);
		this.lifetime--;
		if(this.lifetime <= 0) {
			this.isDead = true;
			if(this.spriteID == Sprites.APPEAR) Game.INST.spawnEnemy(this.x,this.y);
		}
	}
	,__class__: Particle
});
var ParticleType = $hxClasses["ParticleType"] = { __ename__ : true, __constructs__ : ["DEFAULT","SIZE_A_PART","SIZE_B_PART","SIZE_C_PART","SPLIT_A","SPLIT_B","APPEAR"] };
ParticleType.DEFAULT = ["DEFAULT",0];
ParticleType.DEFAULT.toString = $estr;
ParticleType.DEFAULT.__enum__ = ParticleType;
ParticleType.SIZE_A_PART = ["SIZE_A_PART",1];
ParticleType.SIZE_A_PART.toString = $estr;
ParticleType.SIZE_A_PART.__enum__ = ParticleType;
ParticleType.SIZE_B_PART = ["SIZE_B_PART",2];
ParticleType.SIZE_B_PART.toString = $estr;
ParticleType.SIZE_B_PART.__enum__ = ParticleType;
ParticleType.SIZE_C_PART = ["SIZE_C_PART",3];
ParticleType.SIZE_C_PART.toString = $estr;
ParticleType.SIZE_C_PART.__enum__ = ParticleType;
ParticleType.SPLIT_A = ["SPLIT_A",4];
ParticleType.SPLIT_A.toString = $estr;
ParticleType.SPLIT_A.__enum__ = ParticleType;
ParticleType.SPLIT_B = ["SPLIT_B",5];
ParticleType.SPLIT_B.toString = $estr;
ParticleType.SPLIT_B.__enum__ = ParticleType;
ParticleType.APPEAR = ["APPEAR",6];
ParticleType.APPEAR.toString = $estr;
ParticleType.APPEAR.__enum__ = ParticleType;
var Player = function() {
	MovingEntity.call(this);
	...
	this.collList.push(CollType.ENEMY);
	this.collList.push(CollType.BONUS);
	this.friction = 0.85;
	this.xVelMax = 3;
	this.yVelMax = 3;
...
$hxClasses["SoundMan"] = SoundMan;
SoundMan.__name__ = ["SoundMan"];
SoundMan.init = function() {
	SoundMan.channels = new haxe_ds_StringMap();
};
SoundMan.playOnce = function(s,vol) {
	if(vol == null) vol = 1;
	vol *= SoundMan.VOL_MOD;
	if(s == SoundMan.ENEMY_DEATH) s = s + "" + Std.random(3);
	if(s == SoundMan.PICKUP) s = s + "" + Std.random(3);
	var snd = openfl_Assets.getSound(s + SoundMan.ext);
	if(snd == null) return;
	var st = new openfl_media_SoundTransform(vol);
	snd.play(0,0,st);
};
SoundMan.playLoop = function(s,vol) {
	if(vol == null) vol = 1;
	if(SoundMan.channels.exists(s)) {
		SoundMan.channels.get(s).stop();
		SoundMan.channels.get(s).removeEventListener("soundComplete",SoundMan.soundCompleteHandler);
		SoundMan.channels.remove(s);
	}
	vol *= SoundMan.VOL_MOD;
	var snd = openfl_Assets.getSound(s + SoundMan.ext);
	if(snd == null) return;
	...
	ch.addEventListener("soundComplete",SoundMan.soundCompleteHandler);
	SoundMan.channels.set(s,ch);
};
SoundMan.stopLoop = function(s) {
	if(SoundMan.channels.exists(s)) {
		SoundMan.channels.get(s).stop();
		SoundMan.channels.get(s).removeEventListener("soundComplete",SoundMan.soundCompleteHandler);
		SoundMan.channels.remove(s);
...
SoundMan.soundCompleteHandler = function(e) {
	var $it0 = SoundMan.channels.keys();
	while( $it0.hasNext() ) {
		var k = $it0.next();
		if(SoundMan.channels.get(k) == e.get_currentTarget()) SoundMan.playLoop(k);
	}
};
...
Sprites.init = function() {
	...
	var value = { data : openfl_Assets.getBitmapData("img/player.png"), frames : 4, delay : 8};
	Sprites.sprites.set(Sprites.PLAYER,value);
	var value1 = { data : openfl_Assets.getBitmapData("img/enemy_0.png"), frames : 4, delay : 4};
	Sprites.sprites.set(Sprites.SIZE_A,value1);
	var value2 = { data : openfl_Assets.getBitmapData("img/enemy_1.png"), frames : 12, delay : 6};
	Sprites.sprites.set(Sprites.SIZE_B,value2);
	var value3 = { data : openfl_Assets.getBitmapData("img/enemy_2.png"), frames : 2, delay : 8};
	Sprites.sprites.set(Sprites.SIZE_C,value3);
	var value4 = { data : openfl_Assets.getBitmapData("img/aura.png"), frames : 4, delay : 8};
	Sprites.sprites.set(Sprites.AURA,value4);
	var value5 = { data : openfl_Assets.getBitmapData("img/bonus.png"), frames : 2, delay : 10};
	Sprites.sprites.set(Sprites.BONUS,value5);
	var value6 = { data : openfl_Assets.getBitmapData("img/font.png"), frames : 10, delay : 0};
	Sprites.sprites.set(Sprites.FONT,value6);
	var value7 = { data : openfl_Assets.getBitmapData("img/title.png"), frames : 1, delay : 0};
	Sprites.sprites.set(Sprites.TITLE,value7);
	var value8 = { data : openfl_Assets.getBitmapData("img/gameover.png"), frames : 1, delay : 0};
	Sprites.sprites.set(Sprites.GAME_OVER,value8);
	var value9 = { data : openfl_Assets.getBitmapData("img/bgA.png"), frames : 1, delay : 0};
	Sprites.sprites.set(Sprites.BG_A,value9);
	var value10 = { data : openfl_Assets.getBitmapData("img/bgB.png"), frames : 1, delay : 0};
	Sprites.sprites.set(Sprites.BG_B,value10);
	var value11 = { data : openfl_Assets.getBitmapData("img/bgC.png"), frames : 1, delay : 0};
	Sprites.sprites.set(Sprites.BG_C,value11);
	var value12 = { data : openfl_Assets.getBitmapData("img/bgD.png"), frames : 1, delay : 0};
	Sprites.sprites.set(Sprites.BG_D,value12);
	var value13 = { data : openfl_Assets.getBitmapData("img/bgE.png"), frames : 1, delay : 0};
	Sprites.sprites.set(Sprites.BG_E,value13);
	var value14 = { data : openfl_Assets.getBitmapData("img/bgF.png"), frames : 1, delay : 0};
	Sprites.sprites.set(Sprites.BG_F,value14);
	var value15 = { data : new openfl_display_BitmapData(2,2,false,-1), frames : 1, delay : 0};
	Sprites.sprites.set(Sprites.DEFAULT_PART,value15);
	var value16 = { data : openfl_Assets.getBitmapData("img/parts_0.png"), frames : 4, delay : 10};
	Sprites.sprites.set(Sprites.SIZE_A_PART,value16);
	var value17 = { data : openfl_Assets.getBitmapData("img/parts_1.png"), frames : 4, delay : 10};
	Sprites.sprites.set(Sprites.SIZE_B_PART,value17);
	var value18 = { data : openfl_Assets.getBitmapData("img/parts_2.png"), frames : 4, delay : 10};
	Sprites.sprites.set(Sprites.SIZE_C_PART,value18);
	var value19 = { data : openfl_Assets.getBitmapData("img/split_0.png"), frames : 2, delay : 4};
	Sprites.sprites.set(Sprites.SPLIT_A,value19);
	var value20 = { data : openfl_Assets.getBitmapData("img/split_1.png"), frames : 2, delay : 4};
	Sprites.sprites.set(Sprites.SPLIT_B,value20);
	var value21 = { data : openfl_Assets.getBitmapData("img/appear.png"), frames : 4, delay : 8};
	Sprites.sprites.set(Sprites.APPEAR,value21);
};
...
var Title = function() {
	Entity.call(this);
	this.setAnim(Sprites.TITLE);
};
$hxClasses["Title"] = Title;
Title.__name__ = ["Title"];
Title.__super__ = Entity;
Title.prototype = $extend(Entity.prototype,{
	__class__: Title
});
var Type = function() { };
$hxClasses["Type"] = Type;
...
var UI = function() {
	...
	this.numLetters = 8;
	this.score = 0;
	if(UI.INST != null) throw new js__$Boot_HaxeError(new openfl_errors_Error("UI already instanciated!")); else UI.INST = this;
	this.canvasData = new openfl_display_BitmapData(Game.WIDTH,Game.HEIGHT,true,0);
	this.canvas = new openfl_display_Bitmap(this.canvasData);
...
UI.prototype = {
	update: function() {
		...
		this.entities = this.entities.filter(($_=Game.INST,$bind($_,$_.filterDead)));
		var _g2 = 0;
		var _g11 = this.entities;
		while(_g2 < _g11.length) {
			var e1 = _g11[_g2];
	...
	,render: function() {
		this.canvasData.fillRect(this.canvasData.__rect.clone(),0);
		var _g = 0;
		var _g1 = this.entities;
		while(_g < _g1.length) {
			var e = _g1[_g];
	...
	,reset: function(logoScore) {
		if(logoScore == null) logoScore = false;
		this.entities = [];
		this.scoreLetters = [];
		if(logoScore) this.score = 1101101; else this.score = 0;
		var fontSheet = Sprites.getSheet(Sprites.FONT);
		var letterWidth = fontSheet.data.component.width / fontSheet.frames;
		var letterHeight = fontSheet.data.component.height;
		var wordX = (Game.WIDTH - (letterWidth + this.letterSpacing) * this.numLetters + this.letterSpacing) / 2 | 0;
		var wordY = Game.HEIGHT - letterHeight - 16 | 0;
		var _g1 = 0;
		var _g = this.numLetters;
		while(_g1 < _g) {
			var i = _g1++;
			var e = new UILetter();
			e.x = (letterWidth + this.letterSpacing) * i + wordX;
			e.y = wordY;
			this.entities.push(e);
			this.scoreLetters.push(e);
		}
		this.updateScore();
	}
	,addToScore: function(v) {
		this.score += v;
		if(this.score >= Math.pow(10,this.numLetters)) this.score = Std["int"](Math.pow(10,this.numLetters) - 1);
		this.updateScore();
	}
	,updateScore: function() {
		var str = this.addZeros(this.score);
		var _g1 = 0;
		var _g = str.length;
		while(_g1 < _g) {
			var i = _g1++;
			this.scoreLetters[i].display(str.charAt(i));
		}
	}
	,addZeros: function(s) {
		var string;
		if(s == null) string = "null"; else string = "" + s;
		while(string.length < this.numLetters) string = "0" + string;
		return string;
	}
	,__class__: UI
};
var UILetter = function() {
	Entity.call(this);
	this.setAnim(Sprites.FONT);
};
$hxClasses["UILetter"] = UILetter;
UILetter.__name__ = ["UILetter"];
UILetter.__super__ = Entity;
UILetter.prototype = $extend(Entity.prototype,{
...
ApplicationMain.config = { build : "2", company : "01101101", file : "LD35Haxe", fps : 60, name : "LD35Haxe", orientation : "", packageName : "com.m.LD35Haxe", version : "1.0.0", windows : [{ antialiasing : 0, background : 0, borderless : false, depthBuffer : false, display : 0, fullscreen : false, hardware : false, height : 640, parameters : "{}", resizable : true, stencilBuffer : true, title : "LD35Haxe", vsync : false, width : 640, x : null, y : null}]};
ApplicationMain.AssetNames = ["img/appear.png","img/aura.png","img/aura.psd","img/bg.psd","img/bgA.png","img/bgB.png","img/bgC.png","img/bgD.png","img/bgE.png","img/bgF.png","img/bonus.png","img/enemy_0.png","img/enemy_1.png","img/enemy_2.png","img/font.png","img/gameover.png","img/parts_0.png","img/parts_1.png","img/parts_2.png","img/player.png","img/split_0.png","img/split_1.png","img/title.png","img/title.psd","img/title2.psd","img/Untitled-1.psd","snd/death.ogg","snd/explode0.ogg","snd/explode1.ogg","snd/explode2.ogg","snd/grindLOOP.ogg","snd/pickup0.ogg","snd/pickup1.ogg","snd/pickup2.ogg"];
ApplicationMain.AssetBytes = [1116,7342,571110,2304689,5430,5381,9062,5478,6861,6191,2885,3055,4427,1494,3081,1381,2828,2828,2828,1089,3228,3150,6856,189008,158839,97282,29534,11207,10390,10724,13086,5150,5167,5229];
Game.TAR = new openfl_geom_Rectangle();
Game.TAP = new openfl_geom_Point();
Game.WIDTH = 640;
Game.HEIGHT = 640;
SoundMan.VOL_MOD = 0.75;
SoundMan.ENEMY_DEATH = "snd/explode";
SoundMan.PICKUP = "snd/pickup";
SoundMan.PLAYER_DEATH = "snd/death";
SoundMan.GRIND = "snd/grindLOOP";
SoundMan.ext = ".ogg";
...
Sprites.BG_E = "bg_e";
Sprites.BG_F = "bg_f";
Sprites.DEFAULT_PART = "default_part";
Sprites.SIZE_A_PART = "size_a_part";
Sprites.SIZE_B_PART = "size_b_part";
Sprites.SIZE_C_PART = "size_c_part";
Sprites.SPLIT_A = "split_a";
Sprites.SPLIT_B = "split_b";
Sprites.APPEAR = "appear";
